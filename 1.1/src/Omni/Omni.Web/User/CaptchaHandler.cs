...
namespace Omni.Web.User
{
    public class CaptchaHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            int width = Convert.ToInt32(Util.Common.IsInteger(context.Request["width"]) ? context.Request["width"] : "200");
            int height = Convert.ToInt32(Util.Common.IsInteger(context.Request["height"]) ? context.Request["height"] : "100");
