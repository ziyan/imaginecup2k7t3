...
{
    public class GetUnapprovedForUserHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            trans = Common.Client.TranslationGetUnapprovedForUser();
