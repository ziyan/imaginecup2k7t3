...
{
    public class GetNonPendingApprovalForUserHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            trans = Common.Client.TranslationGetNonPendingApprovalForUser();
